...
可观测性指可以在不了解系统运作的情况下，对该系统提出各类问题，它意在帮助你排查处理新的问题，回答你为什么会出现各种各样的情况。

想要对系统提出各种问题，那么首先应用程序必须发出各类“信号”，比如链路，指标，日志等。开发人员在排查问题时，都想获取足够的信息用来佐证某个情况出现，所以日志显得尤为重要，但是对于网络，追踪方面，在不更改原有程序的情况下显得有点力不从心。

OpenTelemetry 是一种作为应用程序代码进行“插桩”的机制，它的目的是帮助系统变得更容易可观测。
